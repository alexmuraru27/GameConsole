...
make deploy         # Stage everything into the update-server tree: each app's .bin (+ .pak) (content/games), Console.bin (content/os), and, if built, ESP01.bin (content/wifi)
