...
make deploy         # Stage everything into the update-server tree: GameXO.bin + .pak (content/games), Console.bin (content/os), and, if built, ESP01.bin (content/wifi)
