...
typedef enum
{
    ...
    ASSET_ID_WIN_SOUND,
    ASSET_ID_WIN_SOUND_DURATION,
    ASSET_ID_LOOSE_SOUND,
    ASSET_ID_LOOSE_SOUND_DURATION,
    ASSET_ID_DRAW_SOUND,
    ASSET_ID_DRAW_SOUND_DURATION,
    ASSET_ID_WELCOME_SOUND,
    ASSET_ID_WELCOME_SOUND_DURATION,
    ASSET_ID_LAST
} AssetId;
