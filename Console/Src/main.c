...
static uint8_t s_tile_red[TILE_BYTES], s_tile_blue[TILE_BYTES];
...
static uint8_t s_cursor_px[CURSOR_BYTES];
...
static uint8_t s_letter_data[5][LETTER_BYTES];
