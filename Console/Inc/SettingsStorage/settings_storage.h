...
typedef enum
{
    ...
    SETTINGS_STORAGE_STATUS_NOT_FOUND = 1U,
    SETTINGS_STORAGE_STATUS_MAGIC_NUMBER_MISMATCH = 2U,
    SETTINGS_STORAGE_STATUS_CHECKSUM_MISMATCH = 3U,
    SETTINGS_STORAGE_STATUS_STRUCT_VERSION_MISMATCH = 4U,
    SETTINGS_STORAGE_STATUS_STORAGE_FULL = 5U,
    SETTINGS_STORAGE_STATUS_EEPROM_ERROR = 6U,
