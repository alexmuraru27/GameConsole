...
#define LOGGER_GAME LOGGER_LEVEL_DEBUG   /* logs funnelled in from loaded games via api.log() */
#define LOGGER_KERNEL LOGGER_LEVEL_DEBUG /* syscall trust-boundary events: rejected pointers, bad ids */
